<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      <inertia-link class="text-indigo-400 hover:text-indigo-600" :href="route('roles')">Roles</inertia-link>
...
export default {
    ...
    methods:{
        store(){
             this.form.post(this.route('roles.store',[this.assignedPermissions]))
        }
    }  
}
</script>
